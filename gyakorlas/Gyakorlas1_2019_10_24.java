...
public class Gyakorlas1_2019_10_24 {
    ...
    static final String [] users = {"Aladár", "Bendegúz"};
    static int [] data0 = new int[N];
    static int [] data1 = new int[N];
    ...
    public static void readData(String fileName, int [] targetArray, int user) {
    ...
    public static void printData(int [] sourceArray) {
        for(int i = 0; i < N; i++) {
            System.out.printf("%d, ", sourceArray[i]);
        }
        System.out.println();
    }
    public static String printData_biggerDropCount(int [] sourceArray1, int [] sourceArray2, int user1, int user2) {
        String finalStr = "";
    ...
    public static String printData_number6DropCount(int [] sourceArray, int user) {
        String finalStr = "";
    ...
    public static boolean getData_winningSeries(int [] sA1, int [] sA2) {
        int j = 0;
    ...
    public static void showMsg(int msgType, String msgTitle, String msgText) {
